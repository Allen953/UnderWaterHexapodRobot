...
0,0,0,0,0,0
    ...
    { 
        ...
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]-0.01*pi+x;
        ...
        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-x;;
