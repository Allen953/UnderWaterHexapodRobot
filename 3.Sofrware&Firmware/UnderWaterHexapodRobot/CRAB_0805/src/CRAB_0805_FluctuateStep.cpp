...
0,0,0,0,0,0
    ...
    { 
        ...
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
        ...
        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        ...
        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        ...
        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        ...
        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        ...
        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
...
//	fputs("\n",fp);
   ...
   for(int i=1;i<=20;i++)
    { 
        ...
        double z=0.01*(1-cos(t));
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
        end_effector_pose_rm_now.p.data[2]=end_effector_pose_rmstart.p.data[2];
        int rc_rm = tracik_rm_solver.CartToJnt(result_rmlast, end_effector_pose_rm_now, result_rmnow);

        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        end_effector_pose_rf_now.p.data[2]=end_effector_pose_rfstart.p.data[2];
        int rc_rf = tracik_rf_solver.CartToJnt(result_rflast, end_effector_pose_rf_now, result_rfnow);
        print_frame_lambda(end_effector_pose_rf_now);

        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
        end_effector_pose_lf_now.p.data[2]=end_effector_pose_lfstart.p.data[2]+z;
        int rc_lf = tracik_lf_solver.CartToJnt(result_lflast, end_effector_pose_lf_now, result_lfnow);

        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        end_effector_pose_lm_now.p.data[2]=end_effector_pose_lmstart.p.data[2];
        int rc_lm = tracik_lm_solver.CartToJnt(result_lmlast, end_effector_pose_lm_now, result_lmnow);

        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        end_effector_pose_lb_now.p.data[2]=end_effector_pose_lbstart.p.data[2];
        int rc_lb = tracik_lb_solver.CartToJnt(result_lblast, end_effector_pose_lb_now, result_lbnow);

        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        end_effector_pose_rb_now.p.data[2]=end_effector_pose_rbstart.p.data[2];
        int rc_rb= tracik_rb_solver.CartToJnt(result_rblast, end_effector_pose_rb_now, result_rbnow);
...
//	fputs("\n",fp);
    ...
    { 
        ...
        double z=0.01*(1-cos(t));
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        end_effector_pose_rm_now.p.data[2]=end_effector_pose_rmstart.p.data[2];
        int rc_rm = tracik_rm_solver.CartToJnt(result_rmlast, end_effector_pose_rm_now, result_rmnow);

        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        end_effector_pose_rf_now.p.data[2]=end_effector_pose_rfstart.p.data[2];
        int rc_rf = tracik_rf_solver.CartToJnt(result_rflast, end_effector_pose_rf_now, result_rfnow);
        print_frame_lambda(end_effector_pose_rf_now);

        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
        end_effector_pose_lf_now.p.data[2]=end_effector_pose_lfstart.p.data[2];
        int rc_lf = tracik_lf_solver.CartToJnt(result_lflast, end_effector_pose_lf_now, result_lfnow);

        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        end_effector_pose_lm_now.p.data[2]=end_effector_pose_lmstart.p.data[2];
        int rc_lm = tracik_lm_solver.CartToJnt(result_lmlast, end_effector_pose_lm_now, result_lmnow);

        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
        end_effector_pose_lb_now.p.data[2]=end_effector_pose_lbstart.p.data[2]+z;
        int rc_lb = tracik_lb_solver.CartToJnt(result_lblast, end_effector_pose_lb_now, result_lbnow);

        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        end_effector_pose_rb_now.p.data[2]=end_effector_pose_rbstart.p.data[2];
        int rc_rb= tracik_rb_solver.CartToJnt(result_rblast, end_effector_pose_rb_now, result_rbnow);
...
//	fputs("\n",fp);
   ...
   //第四阶段
    ...
    { 
        ...
        double z=0.01*(1-cos(t));
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        end_effector_pose_rm_now.p.data[2]=end_effector_pose_rmstart.p.data[2];
        int rc_rm = tracik_rm_solver.CartToJnt(result_rmlast, end_effector_pose_rm_now, result_rmnow);

        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        end_effector_pose_rf_now.p.data[2]=end_effector_pose_rfstart.p.data[2];
        int rc_rf = tracik_rf_solver.CartToJnt(result_rflast, end_effector_pose_rf_now, result_rfnow);
        print_frame_lambda(end_effector_pose_rf_now);

        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        end_effector_pose_lf_now.p.data[2]=end_effector_pose_lfstart.p.data[2];
        int rc_lf = tracik_lf_solver.CartToJnt(result_lflast, end_effector_pose_lf_now, result_lfnow);

        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
        end_effector_pose_lm_now.p.data[2]=end_effector_pose_lmstart.p.data[2]+z;
        int rc_lm = tracik_lm_solver.CartToJnt(result_lmlast, end_effector_pose_lm_now, result_lmnow);

        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
        end_effector_pose_lb_now.p.data[2]=end_effector_pose_lbstart.p.data[2];
        int rc_lb = tracik_lb_solver.CartToJnt(result_lblast, end_effector_pose_lb_now, result_lbnow);

        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        end_effector_pose_rb_now.p.data[2]=end_effector_pose_rbstart.p.data[2];
        int rc_rb= tracik_rb_solver.CartToJnt(result_rblast, end_effector_pose_rb_now, result_rbnow);
...
//	fputs("\n",fp);
  ...
  //第五阶段
    ...
    { 
        ...
        double z=0.01*(1-cos(t));
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        end_effector_pose_rm_now.p.data[2]=end_effector_pose_rmstart.p.data[2];
        int rc_rm = tracik_rm_solver.CartToJnt(result_rmlast, end_effector_pose_rm_now, result_rmnow);

        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
        end_effector_pose_rf_now.p.data[2]=end_effector_pose_rfstart.p.data[2]+z;
        int rc_rf = tracik_rf_solver.CartToJnt(result_rflast, end_effector_pose_rf_now, result_rfnow);
        print_frame_lambda(end_effector_pose_rf_now);

        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        end_effector_pose_lf_now.p.data[2]=end_effector_pose_lfstart.p.data[2];
        int rc_lf = tracik_lf_solver.CartToJnt(result_lflast, end_effector_pose_lf_now, result_lfnow);

        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
        end_effector_pose_lm_now.p.data[2]=end_effector_pose_lmstart.p.data[2];
        int rc_lm = tracik_lm_solver.CartToJnt(result_lmlast, end_effector_pose_lm_now, result_lmnow);

        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        end_effector_pose_lb_now.p.data[2]=end_effector_pose_lbstart.p.data[2];
        int rc_lb = tracik_lb_solver.CartToJnt(result_lblast, end_effector_pose_lb_now, result_lbnow);

        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        end_effector_pose_rb_now.p.data[2]=end_effector_pose_rbstart.p.data[2];
        int rc_rb= tracik_rb_solver.CartToJnt(result_rblast, end_effector_pose_rb_now, result_rbnow);
...
//	fputs("\n",fp);
  ...
  //第六阶段
    ...
    { 
        ...
        double z=0.01*(1-cos(t));
        //右边
        end_effector_pose_rm_now.p.data[0]=end_effector_pose_rmstart.p.data[0]+0.01*pi-0.02*pi*0.2*4-x*0.2;
        end_effector_pose_rm_now.p.data[2]=end_effector_pose_rmstart.p.data[2];
        int rc_rm = tracik_rm_solver.CartToJnt(result_rmlast, end_effector_pose_rm_now, result_rmnow);

        end_effector_pose_rf_now.p.data[0]=end_effector_pose_rfstart.p.data[0]+0.01*pi-0.02*pi*0.2*0-x*0.2;
        end_effector_pose_rf_now.p.data[2]=end_effector_pose_rfstart.p.data[2];
        int rc_rf = tracik_rf_solver.CartToJnt(result_rflast, end_effector_pose_rf_now, result_rfnow);
        print_frame_lambda(end_effector_pose_rf_now);

        end_effector_pose_lf_now.p.data[0]=end_effector_pose_lfstart.p.data[0]+0.01*pi-0.02*pi*0.2*3-x*0.2;
        end_effector_pose_lf_now.p.data[2]=end_effector_pose_lfstart.p.data[2];
        int rc_lf = tracik_lf_solver.CartToJnt(result_lflast, end_effector_pose_lf_now, result_lfnow);

        end_effector_pose_lm_now.p.data[0]=end_effector_pose_lmstart.p.data[0]+0.01*pi-0.02*pi*0.2*1-x*0.2;
        end_effector_pose_lm_now.p.data[2]=end_effector_pose_lmstart.p.data[2];
        int rc_lm = tracik_lm_solver.CartToJnt(result_lmlast, end_effector_pose_lm_now, result_lmnow);

        end_effector_pose_lb_now.p.data[0]=end_effector_pose_lbstart.p.data[0]+0.01*pi-0.02*pi*0.2*2-x*0.2;
        end_effector_pose_lb_now.p.data[2]=end_effector_pose_lbstart.p.data[2];
        int rc_lb = tracik_lb_solver.CartToJnt(result_lblast, end_effector_pose_lb_now, result_lbnow);

        end_effector_pose_rb_now.p.data[0]=end_effector_pose_rbstart.p.data[0]+0.01*pi-0.02*pi*0.2*5+x;
